...
typedef enum {
    ...
    Meal_PagerCustomEventScannerUp,
    Meal_PagerCustomEventScannerDown,
    Meal_PagerCustomEventScannerLeft,
    Meal_PagerCustomEventScannerRight,
    Meal_PagerCustomEventScannerOk,
    Meal_PagerCustomEventScannerBack,
